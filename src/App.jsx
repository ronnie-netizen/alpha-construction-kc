...
const Navigation = ({ activeSection }) => {
  ...
  return (
    <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 1000, padding: scrolled ? "12px 0" : "20px 0", background: scrolled ? "rgba(26,26,26,0.97)" : "transparent", backdropFilter: scrolled ? "blur(20px)" : "none", borderBottom: scrolled ? `1px solid ${COLORS.charcoal}` : "none", transition: "all 0.4s ease" }}>
      <div style={{ maxWidth: "1320px", margin: "0 auto", padding: "0 40px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "2px", cursor: "pointer", marginRight: "24px", flexShrink: 0 }} onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
        ...
        <div style={{ display: "flex", gap: "16px", alignItems: "center", flexWrap: "nowrap" }}>
          ...
          <a href="https://app.alphaconstructionkc.com" target="_blank" rel="noopener noreferrer" style={{ fontFamily: "'Outfit', sans-serif", fontSize: "11px", fontWeight: 500, letterSpacing: "0.5px", textTransform: "uppercase", color: COLORS.amber, textDecoration: "none", padding: "8px 0", borderBottom: "2px solid transparent", transition: "all 0.3s", whiteSpace: "nowrap" }}>Platform</a>
          <button style={{ background: COLORS.amber, border: "none", color: COLORS.dark, fontFamily: "'Outfit', sans-serif", fontWeight: 600, fontSize: "11px", letterSpacing: "0.5px", textTransform: "uppercase", padding: "10px 16px", cursor: "pointer", transition: "all 0.3s", whiteSpace: "nowrap" }}>Get Estimate</button>
        </div>
      </div>
    </nav>
  );
...
const Hero = () => (
  <section style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", background: COLORS.dark, overflow: "hidden" }}>
    ...
    {/* MBE Badge */}
    <div style={{ position: "absolute", top: "100px", right: "40px", zIndex: 3, display: "flex", gap: "8px", flexWrap: "wrap", justifyContent: "flex-end", maxWidth: "340px" }}>
    ...
    <div style={{ position: "relative", zIndex: 2, maxWidth: "1320px", margin: "0 auto", padding: "120px 40px 80px", width: "100%" }}>
        ...
        <div>
          ...
          <FadeIn delay={0.55}>
            <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
              <button style={{ background: COLORS.amber, border: "none", color: COLORS.dark, fontFamily: "'Outfit', sans-serif", fontWeight: 600, fontSize: "13px", letterSpacing: "2px", textTransform: "uppercase", padding: "18px 40px", cursor: "pointer", transition: "all 0.3s" }}>Request a Bid</button>
              <button style={{ background: "transparent", border: `1px solid ${COLORS.slate}`, color: COLORS.offWhite, fontFamily: "'Outfit', sans-serif", fontWeight: 500, fontSize: "13px", letterSpacing: "2px", textTransform: "uppercase", padding: "17px 36px", cursor: "pointer", transition: "all 0.3s" }}>View Our Work</button>
            </div>
          </FadeIn>
        </div>
      ...
      <FadeIn delay={0.7}>
        <div style={{ marginTop: "80px", display: "grid", gridTemplateColumns: "repeat(4, 1fr)", borderTop: `1px solid ${COLORS.slate}33`, paddingTop: "40px" }}>
    ...
    <section id="services" style={{ background: COLORS.cream, padding: "clamp(80px, 10vw, 140px) 0" }}>
      <div style={{ maxWidth: "1320px", margin: "0 auto", padding: "0 40px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "300px 1fr", gap: "0" }}>
          ...
          <div style={{ padding: "24px 0 24px 60px" }}>
            <FadeIn key={active}>
    ...
    <section id="projects" style={{ background: COLORS.dark, padding: "clamp(80px, 10vw, 140px) 0" }}>
      <div style={{ maxWidth: "1320px", margin: "0 auto", padding: "0 40px" }}>
        ...
        <div style={{ display: "grid", gap: "2px" }}>
          {projects.map((p, i) => (
            <FadeIn key={i} delay={i * 0.1}>
              <div style={{ background: COLORS.darkAlt, padding: "36px 44px", display: "grid", gridTemplateColumns: "1fr auto", gap: "40px", alignItems: "center", transition: "all 0.4s", cursor: "pointer", borderLeft: `3px solid transparent` }}
        ...
        <FadeIn delay={0.5}>
          <div style={{ marginTop: "40px", padding: "32px 40px", border: `1px solid ${COLORS.amber}33`, background: "rgba(200,148,62,0.04)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <button style={{ background: COLORS.amber, border: "none", color: COLORS.dark, fontFamily: "'Outfit', sans-serif", fontWeight: 600, fontSize: "12px", letterSpacing: "1.5px", textTransform: "uppercase", padding: "14px 32px", cursor: "pointer", whiteSpace: "nowrap" }}>Invite Us to Bid</button>
          </div>
        </FadeIn>
      </div>
    </section>
          ...
          <div style={{ background: COLORS.darkAlt, padding: "40px", border: `1px solid ${COLORS.slate}33` }}>
            ...
            {[
              ...
              <div key={i} style={{ marginBottom: "20px" }}>
                ...
                <input type={field.type} style={{ width: "100%", padding: "14px 16px", background: COLORS.charcoal, border: `1px solid ${COLORS.slate}44`, color: COLORS.white, fontFamily: "'Outfit', sans-serif", fontSize: "14px", outline: "none", boxSizing: "border-box", transition: "border-color 0.3s" }}
            ...
            <div style={{ marginBottom: "24px" }}>
              ...
              <textarea rows={4} placeholder="Project name, location, scope of concrete work, timeline, and whether plans are available..." style={{ width: "100%", padding: "14px 16px", background: COLORS.charcoal, border: `1px solid ${COLORS.slate}44`, color: COLORS.white, fontFamily: "'Outfit', sans-serif", fontSize: "14px", outline: "none", resize: "vertical", boxSizing: "border-box", transition: "border-color 0.3s" }}
                onFocus={e => e.target.style.borderColor = COLORS.amber}
                onBlur={e => e.target.style.borderColor = COLORS.slate + "44"} />
            </div>
            <button style={{ width: "100%", padding: "16px", background: COLORS.amber, border: "none", color: COLORS.dark, fontFamily: "'Outfit', sans-serif", fontWeight: 600, fontSize: "13px", letterSpacing: "2px", textTransform: "uppercase", cursor: "pointer", transition: "all 0.3s" }}
